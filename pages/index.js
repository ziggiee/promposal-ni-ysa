  ...
  return (
    <>
      ...
      <div className="flex flex-row items-center justify-evenly w-full h-96 bg-pink-50">
        <CommentedImage src='/ysa1.jpg' text="wow so pretty"/>
        <CommentedImage src='/ysa3.jpg' text="omg we&apos;re so cute"/>
        <CommentedImage src='/ysa2.jpg' text="we should kiss?"/>
      </div>
      ...
      <CornyQuestion 
        ...
        nonactive="https://i.ibb.co/C3yKc6gK/download.jpg" 
        active="https://i.ibb.co/C3yKc6gK/download.jpg"
        secondary
        right
      />
